...
resizebox.stargazer(p3_prereg_base, p3_prereg_mcount, p3_prereg_wcount, p3_prereg_uwcount, type = "latex",
                    ...
                    covariate.labels = c("Treatment\\\\(Co-Partisan Accountability)", "7-Point Ideology", "Male"),
...
stargazer(lm_affpol_1a,lm_affpol_1b, type = "latex",
         ...
         dep.var.labels = "Post-Chat Partisan Affect (D - R Feeling Thermo Diff)", covariate.labels = c("Pre-Chat Affect", "Partner's Pre-Chat Affect", "Partner Sent More Messages", "Partner's Pre-Chat Affect\\\\$\\times$ Partner Sent More Messages", "Partner Wrote More Characters", "Partner's Pre-Chat Affect\\\\$\\times$ Partner Wrote More Characters"))#target
