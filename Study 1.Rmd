...
resizebox.stargazer(lm_char_count, lm_message_count, lm_word_count, lm_unique_word_count, type = "latex",
                    ...
                    covariate.labels = c("Treatment\\\\(Co-Partisan Accountability)", "Extroversion", "Self-Monitoring", "Political Interest", "6-point PID", "Affective Polarization", "Ideological Extremity", "Ideological Identity Strength", "Media Consumption Scale", "Male", "Age", "College", "Social Media Expressor"),
